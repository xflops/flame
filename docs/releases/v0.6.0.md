...
Target final release: end of June 2026
Latest release branch snapshot: June 2, 2026 (`release-0.6` at `12432449`, tagged `v0.6.0-rc2`)

These notes cover the changes between `v0.5.0` and the latest `release-0.6` branch snapshot. Use `v0.6.0-rc2` and `release-0.6` as the current release-candidate source until the final stable `v0.6.0` tag is published.

Compare: https://github.com/xflops/flame/compare/v0.5.0...v0.6.0-rc2

## Current Release Candidate Status

- Source candidate: `v0.6.0-rc2` at `12432449a82079a7773ea833f2a9ac15d9ce3c3f`.
- `flamepy 0.6.0rc2` is published to PyPI: https://pypi.org/project/flamepy/0.6.0rc2/.
- PyPI artifact hashes:
  - `flamepy-0.6.0rc2-py3-none-any.whl`: `sha256:8df46f5bc577b0bf5fb213d8f6aac29165ef6815f225901acdb84240866af02c`
  - `flamepy-0.6.0rc2.tar.gz`: `sha256:66f93c70cc9bec2e0f7e6fd68674f95fdd1ae5d7124a44b3b66432500845c556`
- Docker image tags are published as `v0.6.0-rc2` for `linux/arm64` only:
  - `docker.io/xflops/flame-session-manager:v0.6.0-rc2` (`sha256:05506d9cd77b0d9eac6d02b5a1f7d3df8e53d596095acbeb1f6092848d8968a0`)
  - `docker.io/xflops/flame-object-cache:v0.6.0-rc2` (`sha256:fd57139d91d7e629efd2ff5a6613441e7074a7c0be3f617bfb846ab481156837`)
  - `docker.io/xflops/flame-executor-manager:v0.6.0-rc2` (`sha256:a7b99105996de1f43f77edf4c71d6ae7a2c569d024345d214d3cdaa02d4cecec`)
  - `docker.io/xflops/flame-console:v0.6.0-rc2` (`sha256:5c8b0330324fa41b57414c4a106e851f3323366395084bae31d0473c6bca393c`)
- The `latest` Docker tags have not been moved for this release candidate.
- Rust crate status: `flame-rs 0.6.0-rc2` is published on crates.io and uses `stdng 0.1.8` plus optional `flame-rs-macros 0.6.0-rc1`; no final `0.6.0` Rust crates have been published yet.
- Known release gap: `linux/amd64` Docker images are still pending because the local amd64 builder path failed under QEMU; publish multi-arch Docker manifests before the final stable release.
