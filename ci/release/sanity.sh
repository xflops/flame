...
IMAGE_REPOSITORIES="${RELEASE_SANITY_IMAGE_REPOSITORIES:-flame-session-manager flame-object-cache flame-executor-manager flame-console flame-instance-runtime}"
