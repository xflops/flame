...
The standalone benchmark in `benchmarks/app.py` exercises the App
API against a running Flame cluster. It measures the first service call, then
repeats single-task, 100-task, and 256 KiB payload workloads after warming a
fixed four-instance service. Every result is checked. The Markdown report shows
